    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 text-sm">Prepare smarter. Score better. Succeed consistently.</p>
        </div>

        {/* Main Login Card */}
        <div className="glass-card p-8 mb-6">
          <h2 className="text-2xl font-bold text-white mb-2">Welcome Back</h2>
          <p className="text-white/60 text-sm mb-8">Access your personalized learning dashboard</p>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <p className="text-center text-sm text-white/70">
              ...
              <Link href="/auth/sign-up" className="font-semibold text-primary hover:text-accent transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
